...
function SettingsUI:Create(parent)
    ...
    maxLabel:SetPoint("TOPLEFT", title, "BOTTOMLEFT", 0, -18)
    maxLabel:SetText("Maximum quality")

    local uncommon = CreatePanelButton(frame, "Uncommon", 82)
    uncommon:SetPoint("TOPLEFT", maxLabel, "BOTTOMLEFT", 0, -8)
    local rare = CreatePanelButton(frame, "Rare", 64)
    rare:SetPoint("LEFT", uncommon, "RIGHT", 6, 0)
    local epic = CreatePanelButton(frame, "Epic", 64)
    ...
    local debug = CreateFrame("CheckButton", nil, frame, "UICheckButtonTemplate")
    debug:SetPoint("TOPLEFT", soulbound, "BOTTOMLEFT", 0, -10)
    debug:SetSize(24, 24)
    debug.label = frame:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
    ...
    local trace = CreateFrame("CheckButton", nil, frame, "UICheckButtonTemplate")
    trace:SetPoint("TOPLEFT", debug, "BOTTOMLEFT", 0, -10)
    trace:SetSize(24, 24)
    trace.label = frame:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
    ...
    local simulate = CreateFrame("CheckButton", nil, frame, "UICheckButtonTemplate")
    simulate:SetPoint("TOPLEFT", trace, "BOTTOMLEFT", 0, -10)
    simulate:SetSize(24, 24)
    simulate.label = frame:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
    ...
    note:SetPoint("TOPLEFT", simulate, "BOTTOMLEFT", 4, -18)
    note:SetWidth(500)
